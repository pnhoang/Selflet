...
/**
 * This is the item provider adapter for a {@link selfletbehavior.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SelfletbehaviorPackage.Literals.SERVICE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SelfletbehaviorPackage.Literals.SERVICE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelfletbehaviorPackage.Literals.SERVICE__BEHAVIOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelfletbehaviorPackage.Literals.SERVICE__BEHAVIOR,
				 SelfletbehaviorFactory.eINSTANCE.createBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(SelfletbehaviorPackage.Literals.SERVICE__BEHAVIOR,
				 SelfletbehaviorFactory.eINSTANCE.createElementary()));

		newChildDescriptors.add
			(createChildParameter
				(SelfletbehaviorPackage.Literals.SERVICE__BEHAVIOR,
				 SelfletbehaviorFactory.eINSTANCE.createComplex()));
	}
