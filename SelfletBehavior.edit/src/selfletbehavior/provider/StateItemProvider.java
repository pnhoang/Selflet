...
/**
 * This is the item provider adapter for a {@link selfletbehavior.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SelfletbehaviorPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelfletbehaviorPackage.Literals.STATE__ACTION);
			childrenFeatures.add(SelfletbehaviorPackage.Literals.STATE__NEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelfletbehaviorPackage.Literals.STATE__ACTION,
				 SelfletbehaviorFactory.eINSTANCE.createAction()));

		newChildDescriptors.add
			(createChildParameter
				(SelfletbehaviorPackage.Literals.STATE__NEXT,
				 SelfletbehaviorFactory.eINSTANCE.createCondition()));
	}
