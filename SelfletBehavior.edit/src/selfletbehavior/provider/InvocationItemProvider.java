...
/**
 * This is the item provider adapter for a {@link selfletbehavior.Invocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InvocationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Invocation_doActivity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Invocation_doActivity_feature", "_UI_Invocation_type"),
				 SelfletbehaviorPackage.Literals.INVOCATION__DO_ACTIVITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Invocation)object).getDoActivity();
