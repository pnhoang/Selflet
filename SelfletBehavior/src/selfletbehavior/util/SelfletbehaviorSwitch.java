 ...
 * @generated
 */
public class SelfletbehaviorSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SelfletbehaviorPackage.BEHAVIOR: {
				Behavior behavior = (Behavior)theEObject;
				T result = caseBehavior(behavior);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SelfletbehaviorPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SelfletbehaviorPackage.INIT: {
			...
			case SelfletbehaviorPackage.FINAL: {
				Final final_ = (Final)theEObject;
				T result = caseFinal(final_);
				if (result == null) result = caseState(final_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SelfletbehaviorPackage.INTERMEDIATE: {
				Intermediate intermediate = (Intermediate)theEObject;
				T result = caseIntermediate(intermediate);
				if (result == null) result = caseState(intermediate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SelfletbehaviorPackage.INVOCATION: {
				Invocation invocation = (Invocation)theEObject;
				T result = caseInvocation(invocation);
				if (result == null) result = caseState(invocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
