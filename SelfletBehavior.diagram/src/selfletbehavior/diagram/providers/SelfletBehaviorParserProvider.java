...
public class SelfletBehaviorParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser intermediateCallService_5001Parser;

	/**
	 * @generated
	 */
	private IParser getIntermediateCallService_5001Parser() {
		if (intermediateCallService_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { SelfletbehaviorPackage.eINSTANCE
					.getIntermediate_CallService() };
			MessageFormatParser parser = new MessageFormatParser(features);
			intermediateCallService_5001Parser = parser;
		}
		return intermediateCallService_5001Parser;
	}

	/**
	 * @generated
	 */
	private IParser invocationDoActivity_5002Parser;

	/**
	 * @generated
	 */
	private IParser getInvocationDoActivity_5002Parser() {
		if (invocationDoActivity_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { SelfletbehaviorPackage.eINSTANCE
					.getInvocation_DoActivity() };
			MessageFormatParser parser = new MessageFormatParser(features);
			invocationDoActivity_5002Parser = parser;
		}
		return invocationDoActivity_5002Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case IntermediateCallServiceEditPart.VISUAL_ID:
			return getIntermediateCallService_5001Parser();
		case InvocationDoActivityEditPart.VISUAL_ID:
			return getInvocationDoActivity_5002Parser();
		}
		return null;
	}
