 ...
 * @generated
 */
public class SelfletBehaviorViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return BehaviorEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SelfletBehaviorVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = SelfletBehaviorVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!SelfletBehaviorElementTypes
				...
				if (!BehaviorEditPart.MODEL_ID
						.equals(SelfletBehaviorVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return IntermediateEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!SelfletBehaviorElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = SelfletBehaviorVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(BehaviorEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case IntermediateEditPart.VISUAL_ID:
			return createIntermediate_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case InitEditPart.VISUAL_ID:
			return createInit_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case FinalEditPart.VISUAL_ID:
			return createFinal_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case InvocationEditPart.VISUAL_ID:
			return createInvocation_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createIntermediate_2001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createInit_2002(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Node createFinal_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createInvocation_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	private void stampShortcut(View containerView, Node target) {
		if (!BehaviorEditPart.MODEL_ID.equals(SelfletBehaviorVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", BehaviorEditPart.MODEL_ID); //$NON-NLS-1$
