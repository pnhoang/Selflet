 ...
 * @generated
 */
public abstract class SelfletBehaviorAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SelfletBehaviorDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SelfletBehaviorAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
