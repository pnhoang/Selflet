 ...
 * @generated
 */
public class SelfletBehaviorInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SelfletBehaviorNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				BehaviorEditPart.MODEL_ID));
		SelfletBehaviorDiagramEditorUtil.runWizard(getShell(), wizard,
