...
import selfletbehavior.diagram.edit.policies.Intermediate2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Intermediate2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IntermediateCallService2EditPart) {
			((IntermediateCallService2EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof selfletbehavior.diagram.edit.parts.Intermediate2EditPart) {
			types.add(SelfletBehaviorElementTypes.StateNext_4006);
		}
