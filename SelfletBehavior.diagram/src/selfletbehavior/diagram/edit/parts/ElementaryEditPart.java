...
import selfletbehavior.diagram.edit.policies.ElementaryItemSemanticEditPolicy;
import selfletbehavior.diagram.part.SelfletBehaviorVisualIDRegistry;

/**
 * @generated
 */
public class ElementaryEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ElementaryEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ElementaryItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ElementaryBehaviorFigure();
	}

	/**
	 * @generated
	 */
	public ElementaryBehaviorFigure getPrimaryShape() {
		return (ElementaryBehaviorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ElementaryElementaryBehaviorsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureElementaryBehaviorCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ElementaryElementaryBehaviorsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ElementaryElementaryBehaviorsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureElementaryBehaviorCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ElementaryElementaryBehaviorsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	 ...
	 * @generated
	 */
	public class ElementaryBehaviorFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureElementaryBehaviorCompartmentFigure;

		/**
		 * @generated
		 */
		public ElementaryBehaviorFigure() {
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureElementaryBehaviorCompartmentFigure() {
			return fFigureElementaryBehaviorCompartmentFigure;
		}
