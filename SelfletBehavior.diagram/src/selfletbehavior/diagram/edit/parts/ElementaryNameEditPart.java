 ...
 * @generated
 */
public class ElementaryNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ElementaryNameEditPart(View view) {
		super(view);
	}
			...
			parser = SelfletBehaviorParserProvider
					.getParser(
							...
							SelfletBehaviorVisualIDRegistry
									.getType(selfletbehavior.diagram.edit.parts.ElementaryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
