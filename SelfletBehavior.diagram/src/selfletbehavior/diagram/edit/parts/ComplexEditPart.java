...
import selfletbehavior.diagram.edit.policies.ComplexItemSemanticEditPolicy;
import selfletbehavior.diagram.part.SelfletBehaviorVisualIDRegistry;

/**
 * @generated
 */
public class ComplexEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ComplexEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComplexItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ComplexBehaviorFigure();
	}

	/**
	 * @generated
	 */
	public ComplexBehaviorFigure getPrimaryShape() {
		return (ComplexBehaviorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComplexComplexBehaviorsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureComplexBehaviorCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ComplexComplexBehaviorsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComplexComplexBehaviorsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureComplexBehaviorCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ComplexComplexBehaviorsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	 ...
	 * @generated
	 */
	public class ComplexBehaviorFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureComplexBehaviorCompartmentFigure;

		/**
		 * @generated
		 */
		public ComplexBehaviorFigure() {
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureComplexBehaviorCompartmentFigure() {
			return fFigureComplexBehaviorCompartmentFigure;
		}
