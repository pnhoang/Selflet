 ...
 * @generated
 */
public class ServiceDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ServiceDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = SelfletBehaviorParserProvider
					.getParser(
							...
							SelfletBehaviorVisualIDRegistry
									.getType(selfletbehavior.diagram.edit.parts.ServiceDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
