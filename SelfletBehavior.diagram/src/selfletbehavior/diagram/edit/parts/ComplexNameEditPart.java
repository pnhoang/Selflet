 ...
 * @generated
 */
public class ComplexNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComplexNameEditPart(View view) {
		super(view);
	}
			...
			parser = SelfletBehaviorParserProvider
					.getParser(
							...
							SelfletBehaviorVisualIDRegistry
									.getType(selfletbehavior.diagram.edit.parts.ComplexNameEditPart.VISUAL_ID));
		}
		return parser;
	}
