...
import selfletbehavior.diagram.edit.policies.Invocation2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invocation2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invocation2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invocation2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvocationDoActivity2EditPart) {
			((InvocationDoActivity2EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof selfletbehavior.diagram.edit.parts.Invocation2EditPart) {
			types.add(SelfletBehaviorElementTypes.StateNext_4006);
		}
