 ...
 * @generated
 */
public class ServiceServicesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return SelfletbehaviorPackage.eINSTANCE.getService_Behavior();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<SelfletBehaviorNodeDescriptor> childDescriptors = SelfletBehaviorDiagramUpdater
				.getServiceServicesCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ElementaryEditPart.VISUAL_ID
				|| visualID == ComplexEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<SelfletBehaviorNodeDescriptor> childDescriptors = SelfletBehaviorDiagramUpdater
				.getServiceServicesCompartment_7001SemanticChildren((View) getHost()
						.getModel());
