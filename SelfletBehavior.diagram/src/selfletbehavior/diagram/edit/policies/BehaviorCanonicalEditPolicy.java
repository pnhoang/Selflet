 ...
 * @generated
 */
public class BehaviorCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected void refreshSemantic() {
		...
		for (Iterator<SelfletBehaviorNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			SelfletBehaviorNodeDescriptor next = descriptorsIterator.next();
			String hint = SelfletBehaviorVisualIDRegistry.getType(next
					.getVisualID());
		...
		for (SelfletBehaviorNodeDescriptor next : childDescriptors) {
			String hint = SelfletBehaviorVisualIDRegistry.getType(next
					.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<SelfletBehaviorLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = SelfletBehaviorVisualIDRegistry
			...
			for (Iterator<SelfletBehaviorLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				SelfletBehaviorLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<SelfletBehaviorLinkDescriptor> collectAllLinks(
	...
	private Collection<IAdaptable> createConnections(
			Collection<SelfletBehaviorLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (SelfletBehaviorLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					SelfletBehaviorVisualIDRegistry.getType(nextLinkDescriptor
