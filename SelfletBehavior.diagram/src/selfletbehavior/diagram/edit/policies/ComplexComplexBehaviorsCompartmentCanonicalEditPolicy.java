 ...
 * @generated
 */
public class ComplexComplexBehaviorsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SelfletBehaviorNodeDescriptor> childDescriptors = SelfletBehaviorDiagramUpdater
				.getComplexComplexBehaviorsCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<SelfletBehaviorNodeDescriptor> childDescriptors = SelfletBehaviorDiagramUpdater
				.getComplexComplexBehaviorsCompartment_7003SemanticChildren((View) getHost()
						.getModel());
