 ...
 * @generated
 */
public class SelfletBehaviorBaseItemSemanticEditPolicy extends
		SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected SelfletBehaviorBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(
					SelfletBehaviorBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(
				SelfletBehaviorBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(SelfletBehaviorBaseEditHelper.EDIT_POLICY_COMMAND,
				null);
		request.setParameter(
				SelfletBehaviorBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = SelfletBehaviorElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = SelfletBehaviorDiagramEditorPlugin
