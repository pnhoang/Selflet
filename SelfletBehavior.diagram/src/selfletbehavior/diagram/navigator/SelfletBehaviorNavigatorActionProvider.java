...
import selfletbehavior.diagram.part.SelfletBehaviorDiagramEditor;
 ...
 * @generated
 */
public class SelfletBehaviorNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SelfletBehaviorNavigatorItem) {
					selectedElement = ((SelfletBehaviorNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (BehaviorEditPart.MODEL_ID
							.equals(SelfletBehaviorVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, SelfletBehaviorDiagramEditor.ID);
