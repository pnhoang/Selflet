 ...
 * @generated
 */
public class SelfletBehaviorDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SelfletBehaviorDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SelfletBehaviorDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SelfletBehaviorDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SelfletBehaviorDomainNavigatorItem(
