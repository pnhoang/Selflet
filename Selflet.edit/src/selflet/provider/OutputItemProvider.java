...
/**
 * This is the item provider adapter for a {@link selflet.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelfletPackage.Literals.OUTPUT__PARAMETER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Output.class)) {
			case SelfletPackage.OUTPUT__PARAMETER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelfletPackage.Literals.OUTPUT__PARAMETER,
				 SelfletFactory.eINSTANCE.createParameter()));
	}
