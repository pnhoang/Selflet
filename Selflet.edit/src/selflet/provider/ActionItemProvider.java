...
/**
 * This is the item provider adapter for a {@link selflet.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_file_feature", "_UI_Action_type"),
				 SelfletPackage.Literals.ACTION__FILE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Action)object).getFile();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Action.class)) {
			case SelfletPackage.ACTION__FILE:
