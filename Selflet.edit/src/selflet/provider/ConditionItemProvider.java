...
/**
 * This is the item provider adapter for a {@link selflet.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_file_feature", "_UI_Condition_type"),
				 SelfletPackage.Literals.CONDITION__FILE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Condition)object).getFile();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Condition.class)) {
			case SelfletPackage.CONDITION__FILE:
