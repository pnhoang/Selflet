...
/**
 * This is the item provider adapter for a {@link selflet.Ability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbilityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ability_service_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ability_service_feature", "_UI_Ability_type"),
				 SelfletPackage.Literals.ABILITY__SERVICE,
				 true,
				 false,
				 false,
	...
	protected void addFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ability_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ability_file_feature", "_UI_Ability_type"),
				 SelfletPackage.Literals.ABILITY__FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelfletPackage.Literals.ABILITY__METHODS);
		}
	...
	public String getText(Object object) {
		String label = ((Ability)object).getService();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelfletPackage.Literals.ABILITY__METHODS,
				 SelfletFactory.eINSTANCE.createMethods()));
	}
