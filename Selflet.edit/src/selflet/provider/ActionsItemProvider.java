...
/**
 * This is the item provider adapter for a {@link selflet.Actions} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionsItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelfletPackage.Literals.ACTIONS__ACTION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actions.class)) {
			case SelfletPackage.ACTIONS__ACTION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelfletPackage.Literals.ACTIONS__ACTION,
				 SelfletFactory.eINSTANCE.createAction()));
	}
