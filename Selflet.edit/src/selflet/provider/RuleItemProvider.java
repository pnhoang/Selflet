...
/**
 * This is the item provider adapter for a {@link selflet.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_file_feature", "_UI_Rule_type"),
				 SelfletPackage.Literals.RULE__FILE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Rule)object).getFile();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Rule.class)) {
			case SelfletPackage.RULE__FILE:
