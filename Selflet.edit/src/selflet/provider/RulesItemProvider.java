...
/**
 * This is the item provider adapter for a {@link selflet.Rules} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RulesItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelfletPackage.Literals.RULES__RULE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Rules.class)) {
			case SelfletPackage.RULES__RULE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelfletPackage.Literals.RULES__RULE,
				 SelfletFactory.eINSTANCE.createRule()));
	}
